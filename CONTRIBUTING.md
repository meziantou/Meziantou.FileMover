...
Please read these guidelines before contributing to meziantou/Meziantou.FileMover:
...
If you have questions about how to use meziantou/Meziantou.FileMover, please open a GitHub issue.
...
- Check that new and updated code follows meziantou/Meziantou.FileMover's existing code formatting and naming standard
- Run meziantou/Meziantou.FileMover's unit tests to ensure no existing functionality has been affected
...
By contributing your code to meziantou/Meziantou.FileMover you grant Gérald Barré a non-exclusive, irrevocable, worldwide,
